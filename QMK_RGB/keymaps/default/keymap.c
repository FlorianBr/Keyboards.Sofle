...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----------------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
      LT(_SET,KC_TAB), KC_QUOT, KC_COMM,  KC_DOT,    KC_P,    KC_Y,                          KC_F,    KC_G,    KC_C,    KC_R,    KC_L, KC_SLSH,
  //|----------------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
    LT(_ALT,KC_PAUSE),    KC_A,    KC_O,    KC_E,    KC_U,    KC_I,                          KC_D,    KC_H,    KC_T,    KC_N,    KC_S, KC_MINS,
  //|----------------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
               KC_DEL, KC_SCLN,    KC_Q,    KC_J,    KC_K,    KC_X,  KC_MUTE,    _______,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z, KC_BSLS,
  //|----------------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
                      KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT,   KC_SPC,      KC_ENT, KC_RSFT, KC_RALT,  KC_EQL,MO(_CRS)
  //                \--------+--------+--------+--------+---------|    |-------+--------+--------+--------+-------/
//,
),
  [_QWERTY] = LAYOUT(
  ...
  //|------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
    _______,    U_AE,    U_OE,   ESIGN,    U_UE, _______,                        BRK_L1 , BRK_R1, _______, _______,    U_SS, _______,
  //|------+--------+--------+--------+--------+--------|  =====  |   |  ===  |--------+--------+--------+--------+--------+--------|
  ...
  [_SET] = LAYOUT(
  //,---------------------------------------------------.                     ,-----------------------------------------------------.
    RGB_TOG,RGB_RMOD, RGB_MOD, _______, _______, _______,                   TG(_QWERTY), _______, _______, _______, _______, _______,
  //|------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
